...
export type ButtonColor = 'red' | 'blue' | 'pink' | 'purple' | 'gradient' | 'gray' | 'primary' | 'secondary'
export type ButtonSize = 'xs' | 'sm' | 'lg' | 'default' | 'none' | 'md'
...
const FILLED = {
  default:
    'disabled:bg-white/20 disabled:text-text-white-light',
  ...
  gray: 'bg-dark-700 from-[#7edbdc4d]',
  primary: 'bg-primary text-text-black-pure',
  secondary: 'bg-accent-800 hover:bg-accent-500 border border-primary-700 text-primary-700',
}
