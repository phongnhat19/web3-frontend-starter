...
interface Props {
  ...
  children?: (({ open, onClick, setOpen }: TriggerProps) => ReactNode) | ReactNode
}
  ...
  const trigger = useMemo(
    () =>
      typeof triggerProp === 'function'
        ...
        ? cloneElement(triggerProp as any, { onClick })
        : null,
          ...
          >
            <div
              className={classNames(
                ...
                'inline-block align-bottom rounded-2xl text-left overflow-hidden transform p-4'
              )}
            >
              {children}
            </div>
